...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2024 at 02:51 PM
...
('ADM0003', 'BS Owner', 'owner', '$2y$10$QkUuTcvkcLNZDnCHtGYlXO.80YdIg5o/O60H6pjJQEF7D.6zaTCKG', 'assets/backend/img/default.png', 'owner@gmail.com', '1', 1, '1552819095');
...
--
ALTER TABLE `tbl_token_pelanggan`
  MODIFY `kd_token` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
